...
export default async function CustomersPage(props: PageProps<"/customers">) {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-xl font-bold text-amber-900">顧客管理</h1>
      ...
      <details className="rounded-2xl border border-amber-100 bg-white p-5">
        ...
        <form action={createCustomer} className="mt-4 grid gap-3 sm:grid-cols-2">
          ...
          <input
            ...
            className="rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-amber-500 focus:outline-none"
          />
          <button className="rounded-lg bg-amber-600 px-4 py-2 text-sm font-semibold text-white hover:bg-amber-700 sm:col-span-2">
            登録
          </button>
        </form>
      </details>
